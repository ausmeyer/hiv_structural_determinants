...
def main():
  records = list(SeqIO.parse(open('hiv1_matrix.fasta', 'r'), 'fasta'))

  cleaned_records = clean_records(records)
  
  outfile_dna = open('hiv1_matrix_clean_dna.fasta', 'w')
  outfile_protein = open('hiv1_matrix_clean_protein.fasta', 'w')
