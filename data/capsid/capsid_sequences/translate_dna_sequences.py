...
def main():
  records = list(SeqIO.parse(open('hiv1_capsid.fasta', 'r'), 'fasta'))

  cleaned_records = clean_records(records)
  
  outfile_dna = open('hiv1_capsid_clean_dna.fasta', 'w')
  outfile_protein = open('hiv1_capsid_clean_protein.fasta', 'w')
